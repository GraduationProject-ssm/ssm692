...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=90)


# 第1章 绪论
## 1.1 选题动因
到现在为止，互联网已经进入了千家万户，最普通的平民百姓也有属于自己的智能设备，计算机各种技术的储备也是相当的丰富，并且实现也是没有难度，各行各业，包括一些个人，也积极拥抱互联网时代的到来，也可以说是互联网时代的到来把人们都给包在互联网之中。从刚开始的政府办公，国家企业的开头使用，到如今的老百姓都能用上，别说那些普通企业了。计算机就是有这样的魅力，互联网被称为浪潮不是浪得虚名的。采用计算机技术，开发一些软件，实现软件所在的目的，这是一个常理，这个基础的常理缩短了地域之间的联系，提高了地域竞争水准，减低了人力成本和数据存储成本。本课题研究的学籍管理系统，也是采用了计算机技术，该系统能够提高学生学籍信息数据的检索速度，使用起来非常的方便。
## 1.2 目的和意义
在学籍管理系统实际操作中，使用者会发现使用起来相当的方便，并且对数据的管理者来讲，也能及时的获得自己想要的数据，对整个数据的所有者能提供强大的帮助，学籍管理系统从操作者的角度出发，不管是在数据的接收以及传递，以及处理结果，都有一个很明显的要求，对有效数据的处理，并且形成集合，并且对有效数据集合进行固定化处理，可以得到更有效的数据，有了学籍管理系统，让管理层不至于把大量的人力和财力资源消耗在数据处理整合方面，完全可以让不知疲倦的计算机来进行，不仅投入减低，并且产出也不少。互联网时代就是如此，顺之者昌，响应互联网时代，不至于说可以乘风破浪，起码可以降低直接淘汰出局的几率。学籍管理系统的出现是顺应时代的。


## 1.3 论文结构安排
学籍管理系统的论文结构将从6个章节进行阐述。具体结构安排如下：
...
# 第2章 开发环境与技术
学籍管理系统需要提前对功能进行调查分析，并且根据分析结果进行技术上的辩证，可以选择更合理的开发技术以及开发工具。
## 2.1 Tomcat 简介
...
![打开新的 phpMyAdmin 窗口](/md/blog.013.png "打开新的 phpMyAdmin 窗口")表4.1 成绩信息表

|字段|注释|类型|空|
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|chengji\_name|成绩标题 |varchar(200)|是|
|chengji\_types|学科类型 |int(11)|是|
|yonghu\_id|学生|int(11)|是|
|chengji|成绩|int(11)|是|
|chengji\_file|成绩下载|varchar(200)|是|
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|dianziwendang\_name|文档标题 |varchar(200)|是|
|dianziwendang\_types|文档类型 |int(11)|是|
|yonghu\_id|学生|int(11)|是|
|dianziwendang\_file|文档下载|varchar(200)|是|
|dianziwendang\_content|文档详情|text|是|
|create\_time|创建时间 |timestamp|是|
表4.3 课程信息表
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|kechng\_name|课程名称 |varchar(200)|是|
|kechng\_types|课程类型 |int(11)|是|
|kechng\_photo|课程封面|varchar(200)|是|
|kechng\_file|课程文件|varchar(200)|是|
|kechng\_address|教师 |varchar(200)|是|
|kechng\_content|课程详情|text|是|
|create\_time|创建时间 |timestamp|是|
表4.4 公告信息表
...
|zhengzimianmao\_types|政治面貌 |int(11)|是|
